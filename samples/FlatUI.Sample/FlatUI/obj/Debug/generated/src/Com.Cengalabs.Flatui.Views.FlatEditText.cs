...
namespace Com.Cengalabs.Flatui.Views {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.cengalabs.flatui.views']/class[@name='FlatEditText']"
	[global::Android.Runtime.Register ("com/cengalabs/flatui/views/FlatEditText", DoNotGenerateAcw=true)]
	public partial class FlatEditText : global::Android.Widget.EditText, global::Com.Cengalabs.Flatui.Attributes.IAttributeChangeListener {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/cengalabs/flatui/views/FlatEditText", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FlatEditText); }
		}

		protected FlatEditText (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Landroid_util_AttributeSet_I;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.cengalabs.flatui.views']/class[@name='FlatEditText']/constructor[@name='FlatEditText' and count(parameter)=3 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet'] and parameter[3][@type='int']]"
		[Register (".ctor", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "")]
		public unsafe FlatEditText (global::Android.Content.Context p0, global::Android.Util.IAttributeSet p1, int p2)
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.cengalabs.flatui.views']/class[@name='FlatEditText']/constructor[@name='FlatEditText' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.util.AttributeSet']]"
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.cengalabs.flatui.views']/class[@name='FlatEditText']/constructor[@name='FlatEditText' and count(parameter)=1 and parameter[1][@type='android.content.Context']]"
		[Register (".ctor", "(Landroid/content/Context;)V", "")]
		public unsafe FlatEditText (global::Android.Content.Context p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Cengalabs.Flatui.Views.FlatEditText __this = global::Java.Lang.Object.GetObject<global::Com.Cengalabs.Flatui.Views.FlatEditText> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Cengalabs.Flatui.Attributes Attributes {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.cengalabs.flatui.views']/class[@name='FlatEditText']/method[@name='getAttributes' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.cengalabs.flatui.views']/class[@name='FlatEditText']/method[@name='onThemeChange' and count(parameter)=0]"
